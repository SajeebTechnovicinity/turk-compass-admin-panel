                        ...
                        <div className='form-card'>
                            ...
                            <div className='card-body'>
                                ...
                                <div className='form-group row'>
                                    ...
                                    <div className='col-md-8'>
                                        <select className="form-control" name="city" onChange={(e)=> setSelectedCity(e.target.value)} required>
                                            <option value="">Select One</option>
                        ...
                        <div className='form-card'>
                            ...
                            <div className='card-body'>
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-8">
                                        <div className="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                           <input type="file" name="image" className="selected-files" onChange={convertImageToBase64}/>
                                        </div>
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-8">
                                        <div className="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                          <input type="file" name="cover_image" className="selected-files" onChange={convertCoverImageToBase64}/>
                                        </div>
                                        <div className="file-preview box sm"></div>
                                    </div>
                                </div>
